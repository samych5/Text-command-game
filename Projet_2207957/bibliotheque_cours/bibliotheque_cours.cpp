...
void ouvrirUneConsoleSiTestAvecDebogueur()
{
	...
	if (IsDebuggerPresent() && GetConsoleWindow() == nullptr) {
		...
		// Noter que ceci fait que l'Exlorateur de tests en mode débogage n'affichera pas la sortie standard "Message" du test, on doit la regarder dans la console.  Il affiche tout de même le résultat avec valeur espérée.
